            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                    <div class="px-4 py-5 sm:px-6 border-b border-gray-200">
                        ...
                        <p class="mt-1 text-sm text-gray-500">Silakan isi formulir berikut untuk edit data Staff.</p>
                    </div>
                    <div class="bg-white p-8 border border-gray-200 shadow-sm">
                        <form action="{{ route('headstaff.staff.update', $user) }}" method="POST" class="space-y-6">
                            @csrf
                            @method('PUT')
                            <div>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Password Baru <span class="text-gray-500 text-sm">(Opsional)</span></label>
                                <input
                                    type="password"
                                    name="password"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200"
